...
public class WechatConsts {
    ...
    public static final String TYPE_SUBSCRIBE_USER = "qrscene_user";
    /**
     * 报修人员
     */
    public static final String TYPE_SUBMMITER = "submitter";
    public static final String TYPE_SUBSCRIBE_SUBMMITER = "qrscene_submitter";
    ...
    public static final String URL_OAUTH2_GET_CODE = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=APPID&redirect_uri=REDIRECT_URI&response_type=code&scope=SCOPE&state=STATE&connect_redirect=1#wechat_redirect";
//    public static final String URL_OAUTH2_GET_CODE = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=APPID&redirect_uri=REDIRECT_URI&response_type=code&scope=SCOPE&state=STATE&connect_redirect=1";
    ...
    // 二维码相关
    ///////////////////////
    public static final String URL_GET_QR_CODE = "https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token=ACCESS_TOKEN";
