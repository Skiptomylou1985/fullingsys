...
public final class RegexUtil {
	 ...
	 */
	public static List<String> getHardRegexpArray(String source, String regexp) {
	 ...
	 *         使用方法参见getHardRegexpMatchResult(String, String)}
	 */
	public static List<String> getSoftRegexpArray(String source, String regexp) {
		List<String> tempList = new ArrayList<String>();
	 ...
	 * @param 要匹配的源字符串
	 */
	public static boolean isIcon(String value){
	    return isSoftRegexpValidate(value, icon_regexp);
	}
	...
	public static boolean isEmail(String value){
	    return isSoftRegexpValidate(value, email_regexp);
	}
	...
	public static boolean isUrl(String value){
	    return isSoftRegexpValidate(value, url_regexp);
	}
	...
	public static boolean isHttp(String value){
	    return isSoftRegexpValidate(value, http_regexp);
	}
	...
	public static boolean isDate(String value){
	    return isSoftRegexpValidate(value, date_regexp);
	}
	...
	public static boolean isPhone(String value){
	    return isSoftRegexpValidate(value, phone_regexp);
	}
	...
	public static boolean isIDCard(String value){
	    return isSoftRegexpValidate(value, ID_card_regexp);
	}
	...
	public static boolean isZIP(String value){
	    return isSoftRegexpValidate(value, ZIP_regexp);
	}
	 ...
	 * @param 要匹配的源字符串
	 */
	public static boolean isNonSpecialChar(String value){
	    return isSoftRegexpValidate(value, non_special_char_regexp);
	}
	...
	public static boolean isNonNegativeIntegers(String value){
	    return isSoftRegexpValidate(value, non_negative_integers_regexp);
	}

	/**
	 * isNonZeroNegativeIntegers
	 * @param 要匹配的源字符串
	 */
	public static boolean isNonZeroNegativeIntegers(String value){
	    return isSoftRegexpValidate(value, non_zero_negative_integers_regexp);
	}
	...
	public static boolean isPositiveInteger(String value){
	    return isSoftRegexpValidate(value, positive_integer_regexp);
	}

	/**
	 * isNonPositiveIntegers
	 * @param 要匹配的源字符串
	 */
	public static boolean isNonPositiveIntegers(String value){
	    return isSoftRegexpValidate(value, non_positive_integers_regexp);
	}
	 ...
	 * @param 要匹配的源字符串
	 */
	public static boolean isNegativeIntegers(String value){
	    return isSoftRegexpValidate(value, negative_integers_regexp);
	}
	...
	public static boolean isInteger(String value){
	    return isSoftRegexpValidate(value, integer_regexp);
	}

	/**
	 * isNonNegativeRationalNumbers
	 * @param 要匹配的源字符串
	 */
	public static boolean isNonNegativeRationalNumbers(String value){
	    return isSoftRegexpValidate(value, non_negative_rational_numbers_regexp);
	}
	 ...
	 * @param 要匹配的源字符串
	 */
	public static boolean isPositiveRationalNumbers(String value){
	    return isSoftRegexpValidate(value, positive_rational_numbers_regexp);
	}

	/**
	 * isNonPositiveRationalNumbers
	 * @param 要匹配的源字符串
	 */
	public static boolean isNonPositiveRationalNumbers(String value){
	    return isSoftRegexpValidate(value, non_positive_rational_numbers_regexp);
	}

	/**
	 * isNegativeRationalNumbers
	 * @param 要匹配的源字符串
	 */
	public static boolean isNegativeRationalNumbers(String value){
	    return isSoftRegexpValidate(value, negative_rational_numbers_regexp);
	}
	 ...
	 * @param 要匹配的源字符串
	 */
	public static boolean isRationalNumbers(String value){
	    return isSoftRegexpValidate(value, rational_numbers_regexp);
	}
	...
	public static boolean isLetter(String value){
	    return isSoftRegexpValidate(value, letter_regexp);
	}
	 ...
	 * @param 要匹配的源字符串
	 */
	public static boolean isUpwardLetter(String value){
	    return isSoftRegexpValidate(value, upward_letter_regexp);
	}
	...
	public static boolean isLowerLetter(String value){
	    return isSoftRegexpValidate(value, lower_letter_regexp);
	}
	...
	public static boolean isLetterNumber(String value){
	    return isSoftRegexpValidate(value, letter_number_regexp);
	}
	 ...
	 * @param 要匹配的源字符串
	 */
	public static boolean isLetterNumberUnderline(String value){
	    return isSoftRegexpValidate(value, letter_number_underline_regexp);
	}
}